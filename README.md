...
docker compose exec app php artisan cities:import storage/app/imports/world-cities.csv --version=2026-08-04
```
...
```bash
php artisan cities:import storage/app/imports/world-cities.csv --version=2026-08-04
php artisan cities:import storage/app/imports/world-cities.csv --version=2026-08-04 --force
```
