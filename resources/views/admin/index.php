...
<body>
  ...
  <script>
    ...
    const schemas = {
      ...
      collections: [['title', 'Title', 'text', 1], ['id', 'ID', 'text'], ['explorerImageUrl', 'Explorer image (3:2 transparent)', 'image', 1], ['heroImageUrl', 'Collection page hero image', 'image', 1], ['detail', 'Detail', 'textarea', 1], ['access', 'Available to', 'access'], ['isPublished', 'Published', 'check']],
