...
<body>
  ...
  <div id="app" class="shell hidden">
    <aside class="side">
      ...
      <nav class="nav"><button data-tab="countries">Country heroes</button><button data-tab="sights" class="active">Top sights</button><button
