...
<body>
  ...
  <script>
    const state = { key: sessionStorage.stampoAdminKey || '', tab: 'sights', rows: [], meta: { countries: [], cities: [], collectionKinds: [] }, edit: null };
