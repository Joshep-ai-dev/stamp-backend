...
<body>
  ...
  <div id="app" class="shell hidden">
    <aside class="side">
      ...
      <nav class="nav"><button data-tab="countries" class="active">Country heroes</button><button onclick="showUsStates(this)">US state images</button><button data-tab="cities">Cities</button><button data-tab="sights">Top sights</button><button
