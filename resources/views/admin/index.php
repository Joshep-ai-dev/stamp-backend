...
<body>
  ...
  <script>
    ...
    const schemas = {
      ...
      'daily-destinations': [['isPreview', 'Public preview (Lesson 0 with 10 questions)', 'check'], ['countryId', 'Country', 'country', 1], ...krooIqQuestionFields, ['publishDate', 'Available from (optional)', 'date'], ['isPublished', 'Available in Kroo IQ', 'check']]
    };
