...
Route::get('/images/{folder}/{filename}', [LegacyImageController::class, 'public'])
    ->where('folder', 'sights|users|collection|daily-destinations|countries')
...
Route::middleware(RequireAdminKey::class)->prefix('/admin/api')->group(function (): void {
    ...
    Route::get('/{type}', [AdminController::class, 'index'])->whereIn('type', ['countries', 'sights', 'collections', 'collection-kinds', 'collection-lists', 'daily-destinations']);
    ...
    Route::put('/{type}/{id}', [AdminController::class, 'update'])->whereIn('type', ['countries', 'sights', 'collections', 'collection-kinds', 'collection-lists', 'daily-destinations']);
